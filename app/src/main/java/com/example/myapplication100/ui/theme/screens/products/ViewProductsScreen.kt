package com.example.myapplication100.ui.theme.screens.products
...
import com.example.myapplication100.models.Product
import com.example.myapplication100.navigation.ROUTE_UPDATE_PRODUCT
...
fun ViewProductsScreen(navController:NavHostController) {
    Image(painter = painterResource(id = R.drawable.medal), contentDescription ="", contentScale = ContentScale.FillBounds, modifier = Modifier.fillMaxSize() )
